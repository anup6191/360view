    ...
    e.fn.TreeSixtyImageRotate = function (t) {
        ...
        return (
            (n.initTreeSixty = function () {
               // n.css({ height: i.smallHeight, width: i.smallWidth, position: "relative", margin: "auto" }), i.spinner && n.spinner("start"), this.loadImages(), i.navigation ;
            ...
            (n.loadImages = function () {
                ...
                for (let t = 0; t < i.totalFrames + 1; t++)
                    (s = e("<li/>").attr({ class: "images-display image-" + t + (0 === t ? " active" : "") })), (l = e("<img/>").attr({ src: i.imagesFolder + i.imgPrefix + t + i.extension })), s.append(l), a.append(s);
